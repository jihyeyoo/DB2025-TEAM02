...
import DAO.ReviewCertHistoryDAO;
...
public class ReviewCertHistory extends JFrame {
    ...
    private void loadCertHistory(int studyId, int userId) {
        ReviewCertHistoryDAO dao = new ReviewCertHistoryDAO();
        List<ReviewCertHistoryDTO> list = dao.getUserCertHistory(studyId, userId);

        for (ReviewCertHistoryDTO dto : list) {
